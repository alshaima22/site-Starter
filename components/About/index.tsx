        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="mt-10 flex flex-col items-center gap-8 md:flex-row lg:gap-32.5">
            ...
            >
              <div className="absolute inset-0 rounded-md bg-gradient-to-b from-orange-100 to-transparent"></div>
              <Image
                src="/images/about/transportation.svg"
                alt="About"
                className="dark:hidden"
                fill
              />
            ...
            >
              <span className="font-medium uppercase text-black dark:text-white">
                <span className="mb-4 mr-4 inline-flex rounded-full bg-meta px-4.5 py-1 text-metatitle uppercase text-white ">
                  {t("about.projects.project2.new")}
                </span>{" "}
                {t("about.projects.project2.title")}
              </span>
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
                <span className="relative inline-block before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full before:bg-titlebg dark:before:bg-titlebgdark">
                  {t("about.projects.project2.heading")}
                </span>
              </h2>
              <p>{t("about.projects.project2.description")}</p>

              {(
                t("about.projects.project2.features", {
                  returnObjects: true,
                }) as any[]
              ).map((feature: any, index: number) => (
                <div key={index} className="mt-7.5 flex items-center gap-5">
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="mt-10 flex flex-col items-center gap-8 md:flex-row lg:gap-32.5">
            ...
            >
              <span className="font-medium uppercase text-black dark:text-white">
                <span className="mb-4 mr-4 inline-flex rounded-full bg-meta px-4.5 py-1 text-metatitle uppercase text-white ">
                  {t("about.projects.project3.new")}
                </span>{" "}
                {t("about.projects.project3.title")}
              </span>
              <h2 className="relative mb-6 text-3xl font-bold text-black dark:text-white xl:text-hero">
                <span className="relative inline-block before:absolute before:bottom-2.5 before:left-0 before:-z-1 before:h-3 before:w-full before:bg-titlebg dark:before:bg-titlebgdark">
                  {t("about.projects.project3.heading")}
                </span>
              </h2>
              <p>{t("about.projects.project3.description")}</p>

              {(
                t("about.projects.project3.features", {
                  returnObjects: true,
                }) as any[]
              ).map((feature: any, index: number) => (
                <div key={index} className="mt-7.5 flex items-center gap-5">

    ...
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <p className="mb-4 w-[90%]">
                    {t("subscribeToReceiveUpdates")}
                  </p>
                  <ul className="mt-5 flex items-center gap-5">
                  <li>
                    <a
                      href="https://www.facebook.com/share/161BKwwgLD/?mibextid=wwXIfr"
          ...
          {/* <!-- Footer Bottom --> */}
          <div className="flex flex-col items-center justify-center gap-5 border-t border-stroke py-5 text-center dark:border-strokedark lg:flex-row lg:justify-center lg:gap-0">
            <motion.div
              variants={{
                hidden: {
                  opacity: 0,
